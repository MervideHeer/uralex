...
The root-meaning relationships and correlate relationships in the current version of the dataset are based on published etymological references, mostly those published before 2014 but also newer sources were taken into account when appropriate. The loanword information is compiled from literature published by the end of 2025.
...
Information from the UraLex basic vocabulary dataset or its predecessor, the BEDLAN cognate database, has featured in Honkola *et al.* (2013), Syrjänen *et al.* (2013), Lehtinen *et al.* (2014), List *et al.* (2017) and Tambets *et al.* (2018). UraLex 2.0 had been used in De Heer & Maurits (2025).
...
De Heer, M. & L. Maurits. (2025) “Stability of meanings in basic vocabulary lists of Uralic languages” Eesti ja soome-ugri keeleteaduse ajakiri. Journal of Estonian and Finno-Ugric Linguistics 16(2), 217–256. DOI: 10.12697/jeful.2025.16.2.07.
